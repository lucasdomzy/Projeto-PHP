...
<div class="container">
    <h1 class="my-4 text-center">Cadastro de Tênis</h1>
    <div class="row">
        <div class="col-md-4"></div>
        <div class="col-md-5 m-2 p-3">
            <?php
            session_start();
            if (isset($_SESSION['mensagem_tenis'])) {
                echo '<div class="alert alert-success" role="alert">';
                echo $_SESSION['mensagem_tenis'];
                echo '</div>';
                unset($_SESSION['mensagem_tenis']);
            }
            ?>
            <form action="cadastraTenis.php" method="post">
                <div class="mb-3">
